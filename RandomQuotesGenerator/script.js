...
var headingP = document.querySelector(".heading-p");
headingP.innerHTML = `This generator randomly pulls from my collection of favorite quotes,
  just over ${quotes.length} as of ${monthName} ${year}.`;
...
function printQuote() {
  ...
  var quoteContainer = document.querySelector(".quote-area");
  var quoteString = `<p class="quote">${randomQuote.quote}</p><p class="source">${randomQuote.source}`;
  ...
  quoteContainer.style.border = `2px solid ${getRandomColor()}`;
}
...
document
  ...
  function copyQuoteToClipboard() {
    var quoteText = document.querySelector(".quote").innerText;
...
document.querySelector(".quote-area").addEventListener("click", copyQuoteToClipboard, false);